...
#part /usr2 --fstype="xfs" --ondisk=sdc --grow
part swap --fstype="swap" --ondisk=sdc --recommended
part /boot/efi --fstype="efi" --ondisk=sdc --size=600 --fsoptions="umask=0077,shortname=tflinux"
part / --fstype="xfs" --ondisk=sdc --size=8092
...
cd /tmp
curl -O http://rhel8repo.centralus.cloudapp.azure.com/support/fuse-sshfs-2.8-7.el8.x86_64.rpm
yum -y localinstall ./fuse-sshfs-2.8-7.el8.x86_64.rpm
